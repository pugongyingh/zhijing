	...
	initModule=function($container){
		...
		$('.moikit-gn-box a').click(function(){
			...
			switch(num){
				case 0:
					//pageScrollTo(0)
					pageScrollTo($('.moikit-gene-pta').offset().top)
				break;
				case 1:
					pageScrollTo($('.moikit-gene-ptb').offset().top)
				break;
				case 2:
					pageScrollTo($('.moikit-gene-ptf').offset().top)
				break;
				case 3:
					pageScrollTo($('.moikit-gene-ptm').offset().top)
				break;
			}
			
			$('.moikit-gn-box a').removeClass('moikit-gn-action');
			$('.moikit-gn-box a').eq(num).addClass('moikit-gn-action');
			$('.moikit-gn-box a').eq(num+7).addClass('moikit-gn-action');
		});
	}
